package com.example.flutter_simple_widget
 ...
 */
class SimpleTodoWidget : AppWidgetProvider() {
...
internal fun updateAppWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
    ...
    val views = RemoteViews(context.packageName, R.layout.simple_todo_widget)
